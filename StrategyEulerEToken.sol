...
contract Strategy is BaseStrategy {
    ...
    constructor(address _vault) public BaseStrategy(_vault) {
        ...
        eToken = IeToken(euler.underlyingToEToken(want));
    ...
    function prepareReturn(uint256 _debtOutstanding) internal override returns(uint256 _profit, uint256 _loss, uint256 _debtPayment){
        ...
        _profit = eToken.balanceOfUnderlying(address(this)).sub(vault.strategies(address(this))['totalDebt']);
    ...
    function protectedTokens() internal view override returns(address[] memory){
        ...
        protected[0] = eToken; // Replace with the actual fcToken address please.
